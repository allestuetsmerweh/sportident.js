...
export interface IPCardStorageFields extends IBaseSiCardStorageFields {
    uid: number;
    cardSeries: keyof typeof ModernSiCardSeries;
}

export const pCardStorageLocations: storage.ISiStorageLocations<IPCardStorageFields> = {
...
export const pCardStorageDefinition = storage.defineStorage(
    0x100,
    pCardStorageLocations,
);
