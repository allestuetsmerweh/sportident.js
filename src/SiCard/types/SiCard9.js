...
SiCard9.StorageDefinition = utils.defineStorage(0x100, {
    ...
    punches: new utils.SiArray(50, (i) => new utils.SiDict({
        code: new utils.SiInt([[56 + i * 4 + 1]]),
        time: new utils.SiInt([[56 + i * 4 + 2], [56 + i * 4 + 3]]),
    })).modify(
        (allPunches) => {
