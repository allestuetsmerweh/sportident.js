    ...
    typeSpecificRead() {
        ...
        return this.mainStation.sendMessage({
            ...
            .then((data4) => {
                ...
                const is4LastBlock = readSiCard10TimeBlock(page4, this.punches, 0, len);
                if (is4LastBlock) {
                    return this;
                }
                return this.mainStation.sendMessage({
                    ...
                    const is5LastBlock = readSiCard10TimeBlock(page5, this.punches, 1, len);
                    if (is5LastBlock) {
                        return this;
                    }
                    return this.mainStation.sendMessage({
                        ...
                        const is6LastBlock = readSiCard10TimeBlock(page6, this.punches, 2, len);
                        if (is6LastBlock) {
                            return this;
                        }
                        return this.mainStation.sendMessage({
                            ...
                            readSiCard10TimeBlock(page7, this.punches, 3, len);
                            return this;
                        });
                    });
                });
