...
exports.timeoutRejectPromise = exports.timeoutResolvePromise = exports.buildSiProtoCommand = exports.processSiProto = exports.getLookup = exports.CRC16 = exports.unPrettyHex = exports.prettyHex = exports.arr2cardNumber = exports.date2arr = exports.arr2date = exports.arr2time = exports.arr2big = exports.isByte = exports.iterable2arr = undefined;
    ...
    _createClass(SiMainStationSimulator, [{
        ...
        value: function sendMessage(message) {
            ...
            if (message.command === cmd.SIGNAL) {
                ...
                var newTime = _index2.default.utils.arr2date(message.parameters.slice(0, 7));
                this.dispatchMessage({
                    command: cmd.SET_TIME,
                    parameters: [].concat(_toConsumableArray(this.getCode()), _toConsumableArray(_index2.default.utils.date2arr(newTime)))
                });
...
(0, _jquery2.default)().ready(function () {
    _index2.default.onLoad = function () {
        ...
        var tests = {
            'card': function card() {
                var mainStation = getSelectedMainStation();
        ...
        var commands = {
            ...
            'send': function send(userLine) {
                var usage = _index2.default.utils.timeoutResolvePromise('Usage: send [command]: [parameters]: [numResp]');
                var res = /send\s+([0-9a-fA-F\s]+)\s*:\s*([0-9a-fA-F\s]+)\s*:\s*([0-9]+)/.exec(userLine);
                if (res === null) {
                    return usage;
                }
                ...
                var mainStation = getSelectedMainStation();
                return mainStation._sendCommand(command, parameters, numResp).then(function (respParameters) {
                    return 'Answer: ' + respParameters;
                });
            },
            'pipe': function pipe(userLine) {
                var usage = _index2.default.utils.timeoutResolvePromise('Usage: pipe [URL]<br />e.g. pipe unix:///tmp/vwin_com1');
                var res = /pipe ([^\s]+)/.exec(userLine);
                if (res === null) {
                    return usage;
                }
                var url = res[1];
                return new Promise(function (resolve, _reject) {
                    ...
                    var userInput = (0, _jquery2.default)('#mainstation-detail-userinput');
            ...
            'simulate': function simulate(userLine) {
                ...
                var mainStationStorageBytes = _index2.default.utils.unPrettyHex(mainStationStorage);

                var url = res[2];
                return new Promise(function (resolve, _reject) {
                    var siSimulator = new _SiSimulator.SiSimulator(url);
                    var siMainStationSimulator = new _SiMainStationSimulator.SiMainStationSimulator(mainStationStorageBytes);
                    siSimulator.onMessage = function (message) {
                        console.log('SiSimulator:', message);
        ...
        var updateMainStationDetail = function updateMainStationDetail() {
            ...
            userInput.on('keydown', function (e) {
                if (e.keyCode === 13) {
                    ...
                    logLine('> ' + userLine);
                    var command = /^[^\s]+/.exec(userLine);
                    if (command && command[0] in commands) {
                        commands[command[0]](userLine).then(function (response) {
                            logLine('' + response);
                        });
                    } else {
