        ...
        value: function sendMessage(message) {
            ...
            if (message.command === cmd.SIGNAL) {
                ...
                newContent.forEach(function (newByte, index) {
                    _this.storage[_offset + index] = newByte;
                });
                this.dispatchMessage({
                ...
                this.dispatchMessage({
                    command: cmd.GET_SI5,
                    parameters: [].concat(_toConsumableArray(this.getCode()), _toConsumableArray(this.currentCard ? this.currentCard : []))
                });
...
var simulateCommand = exports.simulateCommand = function simulateCommand(context) {
    ...
    var cardSimulations = {
        'SI5': {
            type: _index2.default.Card.Type.SICard5,
            storage: _index2.default.utils.unPrettyHex('aa 29 00 01 19 02 04 00 00 00 00 00 00 00 00 00' + '65 19 02 1d db 1e 2f 03 56 ee ee 28 04 1f 00 07' + '00 1f 1e 02 20 1e 13 00 ee ee 00 ee ee 00 ee ee' + '00 00 ee ee 00 ee ee 00 ee ee 00 ee ee 00 ee ee' + '00 00 ee ee 00 ee ee 00 ee ee 00 ee ee 00 ee ee' + '00 00 ee ee 00 ee ee 00 ee ee 00 ee ee 00 ee ee' + '00 00 ee ee 00 ee ee 00 ee ee 00 ee ee 00 ee ee' + '00 00 ee ee 00 ee ee 00 ee ee 00 ee ee 00 ee ee')
        }
    };
    ...
    return new Promise(function (resolve, _reject) {
        ...
        var onSubCommand = function onSubCommand(e) {
            ...
            if (subResIn) {
                var simulationName = subResIn[1];
                if (!(simulationName in cardSimulations)) {
                    return;
                }
                var simulation = cardSimulations[simulationName];
